...
<!-- gen:snapshot -->
> **Live snapshot** · 1380 contributions in the last 365 days · 585 commits · 211 pull requests · 15 repositories touched in the last 90 days · current streak 0 days.
>
> Rendered 2026-09-20 04:49 UTC by [`tools/render`](tools/render) — every number and every pixel above comes from the GitHub GraphQL API, not from a third-party badge service.
<!-- /gen:snapshot -->
...
**[Constellation](https://github.com/Navesz/constellation)** — `TypeScript` · updated 25d ago  
An observatory for public GitHub signals — profiles, achievements and activity, measured honestly instead of gamified.

**[Galegos](https://github.com/Navesz/Galegos)** — `TypeScript` · updated 25d ago  
