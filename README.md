...
<!-- gen:snapshot -->
> **Live snapshot** · 1290 contributions in the last 365 days · 559 commits · 182 pull requests · 15 repositories touched in the last 90 days · current streak 2 days.
>
> Rendered 2026-09-14 12:39 UTC by [`tools/render`](tools/render) — every number and every pixel above comes from the GitHub GraphQL API, not from a third-party badge service.
<!-- /gen:snapshot -->
...
**[OpenParts](https://github.com/Navesz/openparts)** — `Svelte` · updated 8d ago  
...
**[Constellation](https://github.com/Navesz/constellation)** — `TypeScript` · updated 19d ago  
An observatory for public GitHub signals — profiles, achievements and activity, measured honestly instead of gamified.

**[Galegos](https://github.com/Navesz/Galegos)** — `TypeScript` · updated 19d ago  
