...
<!-- gen:snapshot -->
> **Live snapshot** · 1178 contributions in the last 365 days · 522 commits · 169 pull requests · 12 repositories touched in the last 90 days · current streak 10 days.
>
> Rendered 2026-09-07 12:25 UTC by [`tools/render`](tools/render) — every number and every pixel above comes from the GitHub GraphQL API, not from a third-party badge service.
<!-- /gen:snapshot -->
...
**[OpenParts](https://github.com/Navesz/openparts)** — `Svelte` · updated 1d ago  
...
**[Constellation](https://github.com/Navesz/constellation)** — `TypeScript` · updated 12d ago  
An observatory for public GitHub signals — profiles, achievements and activity, measured honestly instead of gamified.

**[Galegos](https://github.com/Navesz/Galegos)** — `TypeScript` · updated 12d ago  
